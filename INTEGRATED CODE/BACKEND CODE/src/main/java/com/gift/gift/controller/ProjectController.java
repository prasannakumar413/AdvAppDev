...
public class ProjectController {
    ...
    public ProjectModel updateProductPrice(@PathVariable("productId") int productId,
            @PathVariable("newPrice") double newPrice) {
        return stuService.updateProductPrice(productId, newPrice);
    }
}
